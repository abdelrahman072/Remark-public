<link rel="stylesheet" href="global/vendor/ladda/ladda.min.css?v4.0.2">
<link rel="stylesheet" href="base/assets/examples/css/uikit/buttons.min.css?v4.0.2">
...
<div class="page-header d-flex align-items-center justify-content-between pb-25">
    <div>
        ...
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active"><span aria-current="location">Buttons</span></li>
        </ol>
    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Use any of the available button classes to quickly create a styled
                            button . We provide a variety of colors for you to express
                                ...
                                <div class="example">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Normal</p>
                                        ...
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Hover</p>
                                        ...
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">active</p>
                                ...
                                <div class="example">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Normal</p>
                                                <span class="font-size-12">#3e8ef7</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Hover</p>
                                                <span class="font-size-12">#589ffc</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">active</p>
                                                <span class="font-size-12">#247cf0</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="example">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Normal</p>
                                                <span class="font-size-12">#11c26d</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Hover</p>
                                                <span class="font-size-12">#28d17c</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">active</p>
                                                <span class="font-size-12">#05a85c</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="example">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Normal</p>
                                                <span class="font-size-12">#0bb2d4</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Hover</p>
                                                <span class="font-size-12">#28c0de</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">active</p>
                                                <span class="font-size-12">#0099b8</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="example">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Normal</p>
                                                <span class="font-size-12">#eb6709</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Hover</p>
                                                <span class="font-size-12">#f57d1b</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                ...
                                <div class="example">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Normal</p>
                                                <span class="font-size-12">#ff4c52</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">Hover</p>
                                                <span class="font-size-12">#ff666b</span>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            ...
                                            <div class="ml-35">
                                                <p class="font-size-14 grey-600 m-0">active</p>
                                                <span class="font-size-12">#f2353c</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="row row-lg">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Round button and the square button can be used to distinguish
                            th different behavior or style.</p>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="example example-buttons">
                                    <div>
            ...
            <div class="row row-lg">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example example-buttons">
                            <button type="button" class="btn btn-default btn-outline btn-block"><i class="icon wb-menu float-right" aria-hidden="true"></i>Default</button>
            ...
            <div class="row row-lg">
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example example-buttons">
                            ...
                            <button type="button" class="btn btn-direction btn-bottom btn-success btn-outline">Down
                                Button</button>
                            <button type="button" class="btn btn-direction btn-left btn-danger btn-outline">Left
                                Button</button>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Floating action buttons are used for a special type of promoted
                            ...
                            <br /> Use the default class <code>.btn</code> with an additional
                            class <code>.btn-floating</code> .</p>
                        <div class="example example-buttons">
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Raised buttons behave like a piece of material resting on another
                            ...
                            <br /> Flat buttons are printed on the material. They do not lift
                            but fill with color on press.</p>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="example example-buttons">
                                    <button type="button" class="btn btn-raised btn-primary btn-block">Normal</button>
                                    <button type="button" class="btn btn-raised btn-primary btn-block hover">Hover</button>
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Create a button like pill by <code>.btn-pill-left</code> or <code>.btn-pill-right</code> with
                            <code>.btn-round</code>.</p>
                        <div class="example example-buttons">
                            <div>
                                <button type="button" class="btn btn-round btn-default btn-outline btn-pill-left">Pill
                                    Left</button>
                                <button type="button" class="btn btn-round btn-default btn-outline btn-pill-right">Pill
                                    Right</button>
                            </div>
                            <div>
                                <button type="button" class="btn btn-round btn-primary btn-pill-left">Pill Left</button>
                                <button type="button" class="btn btn-round btn-primary btn-pill-right">Pill
                                    Right</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Basic buttons are traditional buttons with borders and background
                            ...
                            on the left or the right which ever you want with different
                            color opitons.</p>
                        <div class="example example-buttons">
                            <button type="button" class="btn btn-dark"><i class="icon wb-upload" aria-hidden="true"></i>
                                Upload</button>
                            ...
                            <button type="button" class="btn btn-danger"><i class="icon wb-link" aria-hidden="true"></i>
                                Link</button>
                            <button type="button" class="btn btn-info"><i class="icon wb-chat" aria-hidden="true"></i>
                                Comment</button>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="example-wrap m-lg-0">
                        ...
                        <div class="example example-buttons">
                            <button type="button" class="btn btn-tagged social-facebook">
                                <span class="btn-tag"><i class="icon bd-facebook" aria-hidden="true"></i></span>Facebook</button>
                            <button type="button" class="btn btn-tagged social-twitter">
                                <span class="btn-tag"><i class="icon bd-twitter" aria-hidden="true"></i></span>Twitter</button>
                            <button type="button" class="btn btn-tagged social-google-plus">
                                <span class="btn-tag"><i class="icon bd-google-plus" aria-hidden="true"></i></span>Google+</button>
                            <button type="button" class="btn btn-tagged social-linkedin">
                                <span class="btn-tag"><i class="icon bd-linkedin" aria-hidden="true"></i></span>Linkedin</button>
                            <button type="button" class="btn btn-tagged social-flickr">
                                <span class="btn-tag"><i class="icon bd-flickr" aria-hidden="true"></i></span>Flickr</button>
                            <button type="button" class="btn btn-tagged social-tumblr">
                                <span class="btn-tag"><i class="icon bd-tumblr" aria-hidden="true"></i></span>Tumblr</button>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="example-wrap m-md-0">
                        ...
                        <p>Different Sizes for you to use with icon button or icon only
                            button.</p>
                        <div class="example example-buttons">
                            <ul class="list-unstyled float-left">
                                <li>
                                    <button type="button" class="btn btn-tagged btn-lg social-facebook">
                                        <span class="btn-tag"><i class="icon bd-facebook" aria-hidden="true"></i></span>Facebook</button>
                                </li>
                                <li>
                                    <button type="button" class="btn btn-tagged social-facebook">
                                ...
                                <li>
                                    <button type="button" class="btn btn-tagged btn-sm social-facebook">
                                        <span class="btn-tag"><i class="icon bd-facebook" aria-hidden="true"></i></span>Facebook</button>
                                </li>
                                <li>
                                    <button type="button" class="btn btn-tagged btn-xs social-facebook">
                                        <span class="btn-tag"><i class="icon bd-facebook" aria-hidden="true"></i></span>Facebook</button>
                                </li>
                            </ul>
            ...
            <div class="row row-lg">
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Grouped buttons give users access to frequently performed actions
                            of a focused task. Wrap a series of buttons with <code>.btn</code> in
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Instead of applying button sizing classes to every button in
                            a group, just add <code>.btn-group-*</code> to each <code>.btn-group</code>,
                            ...
                            <div class="btn-group" aria-label="Button group with nested dropdown" role="group">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="exampleGroupDrop1" role="menu">
                                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem">Dropdown
                                            link</a>
                                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem">Dropdown
                                            link</a>
                                    </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>To use justified button groups with <code>&lt;button&gt;</code> elements, you must wrap each
                            button in a button group. Most
                            browsers don't properly apply our CSS for justification to
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap m-md-0">
                        ...
                        <div class="example example-buttons">
                            <div>
                                <button type="button" class="btn btn-sm btn-primary" data-toggle="button" data-plugin="moreButton" data-more="#exampleMoreless">
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Add <code>data-loading-text=&quot;Loading...&quot;</code> to
                            use a loading state on a button.</p>
                        <div class="example">
                            <button type="button" class="btn btn-primary" id="exampleStatefulButton" data-plugin="loadingButton" data-loading-text="Loading...">
                                Loading state
                            </button>
                        </div>
                    </div>
    ...
    <div class="panel card-shadow">
        <div class="panel-heading">
            <h3 class="panel-title">Ladda Buttons
                <small><a class="example-plugin-link" href="http://msurguy.github.io/ladda/" target="_blank">official
                        website</a></small>
            </h3>
        </div>
            ...
            <div class="row row-lg">
                        ...
                        <div class="example example-buttons">
                            <div class="float-left">
                                <button type="button" class="btn btn-info ladda-button" data-style="expand-left" data-plugin="ladda">
                                    <span class="ladda-label"><i class="icon wb-arrow-expand mr-10" aria-hidden="true"></i>Expand
                                        left</span>
                                </button>
                            </div>
                        ...
                        <div class="example example-buttons">
                            <div class="float-left">
                                <button type="button" class="btn btn-warning ladda-button" data-style="zoom-in" data-plugin="ladda">
                                    <span class="ladda-label"><i class="icon wb-zoom-in mr-10" aria-hidden="true"></i>Zoom
                                        in</span>
                                </button>
                            </div>
                            ...
                            <div class="float-left">
                                <button type="button" class="btn btn-danger ladda-button" data-style="zoom-out" data-plugin="ladda">
                                    <span class="ladda-label"><i class="icon wb-zoom-out mr-10" aria-hidden="true"></i>Zoom
                                        out</span>
                                </button>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example example-buttons">
                            <div class="float-left">
                                <button type="button" class="btn btn-success ladda-button" data-style="expand-left" data-plugin="ladda" data-type="progress">
                                    <span class="ladda-label"><i class="icon wb-arrow-expand mr-10" aria-hidden="true"></i>Expand</span>
                                </button>
                            </div>

                            <div class="float-left">
                                <button type="button" class="btn btn-warning ladda-button" data-style="zoom-in" data-plugin="ladda" data-type="progress">
                                    <span class="ladda-label"><i class="icon wb-zoom-in mr-10" aria-hidden="true"></i>Zoom</span>
                                </button>
                            </div>

                            <div class="float-left">
                                <button type="button" class="btn btn-primary ladda-button" data-style="slide-left" data-plugin="ladda" data-type="progress">
                                    <span class="ladda-label"><i class="icon wb-arrow-left mr-10" aria-hidden="true"></i>Slide</span>
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="example example-buttons">
                            <div class="float-left">
                                <button type="button" class="btn btn-primary ladda-button" data-style="slide-left" data-plugin="ladda">
                                    <span class="ladda-label"><i class="icon wb-arrow-left mr-10" aria-hidden="true"></i>Slide
                                        left</span>
                                </button>
                            </div>
                            ...
                            <div class="float-left">
                                <button type="button" class="btn btn-primary ladda-button" data-style="slide-right" data-plugin="ladda">
                                    <span class="ladda-label">Slide right<i class="icon wb-arrow-right ml-10" aria-hidden="true"></i></span>
                                </button>
                            </div>

                            <div class="float-left">
                                <button type="button" class="btn btn-primary ladda-button" data-style="slide-up" data-plugin="ladda">
                                    <span class="ladda-label"><i class="icon wb-arrow-up mr-10" aria-hidden="true"></i>Slide
                                        up</span>
                                </button>
                            </div>
                            ...
                            <div class="float-left">
                                <button type="button" class="btn btn-primary ladda-button" data-style="slide-down" data-plugin="ladda">
                                    <span class="ladda-label"><i class="icon wb-arrow-down mr-10" aria-hidden="true"></i>Slide
                                        down</span>
                                </button>
                            </div>
                        </div>
...
<? $page_script = "
    <script src='global/vendor/ladda/spin.min.js?v4.0.2'></script>
    <script src='global/vendor/ladda/ladda.min.js?v4.0.2'></script>
    <script src='global/js/Plugin/ladda.js?v4.0.2'></script>
    <script src='global/js/Plugin/loading-button.js?v4.0.2'></script>
    <script src='global/js/Plugin/more-button.js?v4.0.2'></script>
"; ?>