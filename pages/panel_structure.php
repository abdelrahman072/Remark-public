    <div class="page-header d-flex align-items-center justify-content-between pb-25">
      <div>
        <h4 class="mb-0 font-size-18">Panel Structure</h4>
        <ol class="breadcrumb m-0">
          <li class="breadcrumb-item"><a target="_self" href="./" class="">Pages</a></li>
          <li class="breadcrumb-item active"><span aria-current="location">Panel Structure</span></li>
        </ol>
      </div>
    ...
    <div class="page-content container-fluid">
      <div class="row">
        <div class="col-xxl-4 col-lg-6">
          ...
          <div class="panel panel-bordered card-shadow">
        ...
        <div class="col-xxl-4 col-lg-6">
          ...
          <div class="panel card-shadow">
            ...
            <div class="panel-body">
              <div class="progress progress-sm mt-10" data-goal="25">
              ...
              <div class="progress progress-sm" data-goal="-40">
              ...
              <div class="progress progress-sm" data-goal="80">
              ...
              <div class="progress progress-sm" data-goal="30">
        ...
        <div class="col-lg-6">
          ...
          <div class="panel card-shadow">
            ...
            <div class="panel-body h-250 scrollable scrollable-shadow is-enabled scrollable-vertical" data-plugin="scrollable" data-skin="scrollable-shadow">
              <div data-role="container" class="scrollable-container" style="height: 220px; width: 554px;">
                <div data-role="content" class="scrollable-content" style="width: 537px;">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
              ...
              <div class="scrollable-bar scrollable-bar-vertical scrollable-bar-hide" draggable="false">
                <div class="scrollable-bar-handle" style="height: 116.346px;"></div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="panel card-shadow">
            ...
            <div class="panel-body container-fluid h-250 scrollable scrollable-shadow is-enabled scrollable-horizontal" data-show-on-hover="false" data-direction="horizontal" data-skin="scrollable-shadow" data-plugin="scrollable">
              ...
              <div class="scrollable-bar scrollable-bar-horizontal" draggable="false">
                <div class="scrollable-bar-handle" style="width: 160.798px;"></div>
              </div>
            </div>
          </div>
      ...
      <div class="panel card-shadow" id="examplePanelToolbar">
        <div class="panel-heading">
        ...
        <div class="panel-collapse">
          <div class="panel-toolbar" role="toolbar">
            <div class="btn-group" role="group">
              <a class="btn" href="javascript:void(0)" role="button"><i class="icon wb-bold" aria-hidden="true"></i></a>
              <a class="btn" href="javascript:void(0)" role="button"><i class="icon wb-italic" aria-hidden="true"></i></a>
              <a class="btn" href="javascript:void(0)" role="button"><i class="icon wb-underline" aria-hidden="true"></i></a>
              <a class="btn" href="javascript:void(0)" role="button"><i class="icon wb-align-left" aria-hidden="true"></i></a>
              <a class="btn" href="javascript:void(0)" role="button"><i class="icon wb-align-center" aria-hidden="true"></i></a>
              <a class="btn" href="javascript:void(0)" role="button"><i class="icon wb-align-right" aria-hidden="true"></i></a>
              <a class="btn" href="javascript:void(0)" role="button"><i class="icon wb-image" aria-hidden="true"></i></a>
              <a class="btn" href="javascript:void(0)" role="button"><i class="icon wb-table" aria-hidden="true"></i></a>
              <a class="btn" href="javascript:void(0)" role="button"><i class="icon wb-link" aria-hidden="true"></i></a>
            </div>
          </div>
          <div class="panel-body">
            <textarea class="form-control panel-control h-full" placeholder="This is a form textarea..." rows="5"></textarea>
            <button type="button" class="btn btn-primary mt-15">Submit</button>
          </div>
        </div>
      </div>
