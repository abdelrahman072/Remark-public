<!-- Aside  -->
<div class="page-aside card-shadow border-0">
    ...
    <div class="page-aside-inner page-aside-scroll border-0">
...
<div class="page-main">
    <div class="page-header d-flex align-items-center justify-content-between pb-25">
        <div>
            <h4 class="mb-0 font-size-18">Page Aside Right Fixed</h4>
            <p class="mr-5 mb-0">Welcome to logoipsum Dashboard</p>
        </div>
        <div class="page-title-right">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a target="_self" href="./" class="">Pages</a></li>
                <li class="breadcrumb-item active"><span aria-current="location">Fixed Aside Right</span></li>
            </ol>
        </div>
    </div>
