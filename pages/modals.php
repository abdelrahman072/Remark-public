<link rel="stylesheet" href="base/assets/examples/css/uikit/modals.min.css?v4.0.2">
<div class="page-header d-flex align-items-center justify-content-between pb-25">
    <div>
        <h4 class="mb-0 font-size-18">Modals</h4>
        <ol class="breadcrumb m-0">
            <li class="breadcrumb-item"><a target="_self" href="./" class="">Pages</a></li>
            <li class="breadcrumb-item active"><span aria-current="location">Modals</span></li>
        </ol>
    </div>
    <div class="page-title-right">
        <button type="button" class="btn btn-sm btn-icon btn-inverse btn-round" data-toggle="tooltip" data-original-title="Edit">
                ...
                <div class="col-xl-6 col-lg-12">
                    ...
                    <div class="example-wrap">
                        ...
                        <p>Modal disables the original page beneath the overlay. The user
                            needs to take an action or cancel the overlay until he can
                            continue interacting with the original page. Modal are easy
                            to implement, but they should be used sparingly. They interrupt
                            the user flow, make it impossible to interact with the page
                            and the overlay at the same time, and hide the content behind
                            the overlay. This can be very annoying to users.</p>
                        <div class="example example-buttons">
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftyFadeScale" data-toggle="modal" type="button">Fade in &amp; Scale</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftySlideFromRight" data-toggle="modal" type="button">Slide from right</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftySlideFromBottom" data-toggle="modal" type="button">Slide from bottom</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftyNewspaper" data-toggle="modal" type="button">Newspaper</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftyFall" data-toggle="modal" type="button">Fall</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftySideFall" data-toggle="modal" type="button">Slide Fall</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftyFlipHorizontal" data-toggle="modal" type="button">3D Flip horizontal</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftyFlipVertical" data-toggle="modal" type="button">3D Flip vertical</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNifty3dSign" data-toggle="modal" type="button">3D Sign</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftySuperScaled" data-toggle="modal" type="button">Super Scalled</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNiftyJustMe" data-toggle="modal" type="button">Just Me</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNifty3dSlit" data-toggle="modal" type="button">3D Slit</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNifty3dRotateBottom" data-toggle="modal" type="button">3D Rotate Bottom</button>
                            ...
                            <button class="btn btn-outline btn-default" data-target="#exampleNifty3dRotateInLeft" data-toggle="modal" type="button">3D Rotate In Left</button>
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        <div class="example-well h-250 example-modal-top">
                                            <img class="center" src="base/assets/examples/images/modal/modal-position.png" alt="...">
                                        </div>

                                        <button class="btn btn-primary" data-target="#examplePositionTop" data-toggle="modal" type="button">Generate</button>
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        ...
                                        <button class="btn btn-primary" data-target="#examplePositionBottom" data-toggle="modal" type="button">Generate</button>
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        <div class="example-well h-250 example-modal-sidebar">
                                            <img class="center" src="base/assets/examples/images/modal/modal-position-sidebar.png" alt="...">
                                        </div>

                                        <button class="btn btn-primary" data-target="#examplePositionSidebar" data-toggle="modal" type="button">Generate</button>
            ...
            <div class="row row-lg">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            <div class="example-well h-350">
                                <img class="center" src="base/assets/examples/images/modal/form-modal.png" alt="...">
                            </div>
                            <p>This modals including title, input for each field. </p>
                            <button class="btn btn-primary" data-target="#exampleFormModal" data-toggle="modal" type="button">Generate</button>
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            <div class="example-well h-350">
                                <img class="center" src="base/assets/examples/images/modal/multiple-modal.png" alt="...">
                            </div>
                            <p>There is a new modal displayed overlay the first one by clicking
                                the function button. </p>
                            <button class="btn btn-primary" data-target="#exampleMultipleOne" data-toggle="modal" type="button">Generate</button>

                            <!-- Modal -->
                            <div class="modal fade" id="exampleMultipleOne" aria-hidden="true" aria-labelledby="exampleMultipleOne" role="dialog" tabindex="-1">
                                <div class="modal-dialog modal-simple">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary" data-target="#exampleMultipleTwo" data-toggle="modal" data-dismiss="modal">Proceed</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="exampleMultipleTwo" aria-hidden="false" role="dialog" tabindex="-1">
                                <div class="modal-dialog modal-simple">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a class="btn btn-sm btn-white" data-dismiss="modal" href="javascript:void(0)" role="button">Close</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            <div class="example-well h-350">
                                <img class="center" src="base/assets/examples/images/modal/size-modal.png" alt="...">
                            </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            <div class="example-well h-350">
                                <img class="center" src="base/assets/examples/images/modal/tab-modal.png" alt="...">
                            </div>
                            <p>This modal including title, tabs for you display additional
                                content inline in the same modal. </p>
                            <button class="btn btn-primary" data-target="#exampleTabs" data-toggle="modal" type="button">Generate</button>
                                ...
                                <div class="modal-dialog modal-simple">
                                    <div class="modal-content">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                                            <li class="nav-item" role="presentation"><a class="nav-link active" data-toggle="tab" href="#exampleLine1" aria-controls="exampleLine1" role="tab">Home</a></li>
                                            <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#exampleLine2" aria-controls="exampleLine2" role="tab">Components</a></li>
                                            <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#exampleLine3" aria-controls="exampleLine3" role="tab">CSS</a></li>
                                            <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#exampleLine4" aria-controls="exampleLine4" role="tab">JavaScript</a></li>
                                        </ul>
                                        ...
                                        <div class="modal-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="exampleLine2" role="tabpanel">
                                                    Tenuit omni magistra quale honoris, maluisti invidi, successerit
                                                    feramus fere omnium
                                                ...
                                                <div class="tab-pane" id="exampleLine3" role="tabpanel">
                                                    Cernimus nutu. Maioribus solet. Iustitiam conciliant reliquisti
                                                    instituendarum
                                                ...
                                                <div class="tab-pane" id="exampleLine4" role="tabpanel">
                                                    Nec iste vellem, accusamus inesse exhorrescere tertium dominationis
                                                    licebit perpetiuntur,
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            <div class="example-well h-350">
                                <img class="center" src="base/assets/examples/images/modal/accordion-modal.png" alt="...">
                            </div>
                            <p>This modal with accordions to have additional content hidden
                                until the user needs them. </p>

                            <button class="btn btn-primary" data-target="#exampleAccrodionModal" data-toggle="modal" type="button">Generate</button>
                            <!-- Modal -->
                                        ...
                                        <div class="panel-group panel-group-continuous m-0" id="exampleAccrodion1" aria-multiselectable="true" role="tablist">
                                            <div class="panel">
                                                <div class="panel-heading" id="exampleHeadingFirst" role="tab">
                                                    <a class="panel-title" data-parent="#exampleAccrodion1" data-toggle="collapse" href="#exampleCollapseFirst" aria-controls="exampleCollapseFirst" aria-expanded="true">
                                                        First
                                                    </a>
                                                </div>
                                                <div class="panel-collapse collapse show" id="exampleCollapseFirst" aria-labelledby="exampleHeadingFirst" role="tabpanel">
                                                    <div class="panel-body">
                                                        Remissius verear, sabinum concessum linguam umbram saepe
                                                        vendibiliora quoddam terroribus,
                                                        ...
                                                        probatus benivolentiam omnium summum facultas
                                                        fuga, debitis mirari menandri domus molita. Maximisque
                                            ...
                                            <div class="panel">
                                                ...
                                                <div class="panel-collapse collapse" id="exampleCollapseSecond" aria-labelledby="exampleHeadingSecond" role="tabpanel">
                                                    <div class="panel-body">
                                                        Diuturnitatem chremes gratia macedonum referatur intellegitur t
                                                        ea industriae plus,
                                                        ex videmus praetereat ratio mediocrem pro orestem,
                                                        ipsam lictores perpetiuntur aperiri benivolentiam,
                                                        nusquam ignaviamque athenis m plato videamus,
                                                        liberatione scientia nihilo aristotelem quoquo
                                                        consumere latinam, successerit certa morte menandro
                                                        delectatum noster impetu videri senserit, infinitum
                                                        iudicatum misisti conectitur, voce proficiscuntur.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel">
                                                ...
                                                <div class="panel-collapse collapse" id="exampleCollapseThird" aria-labelledby="exampleHeadingThird" role="tabpanel">
                                                    <div class="panel-body">
                                                        Audire scribimus spe platonis longinquitate evertunt scribi,
                                                        notionem doleamus
                                                        ...
                                                        totam familiarem tertium voluntates consilia
                                                        aperiam disputata, plena animumque ius supplicii
                                                        incurrunt laboribus, rationis dedocendi incurreret
                                                        illam triari utrisque eos commodius. Assentiar
                                                        magnitudinem.
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            <div class="example-well h-350">
                                <img class="center" src="base/assets/examples/images/modal/grid-modal.png" alt="...">
                            </div>
                            <p>This modal including title and grids to layout through a series
                                of two columns that house your content. </p>
                            <button class="btn btn-primary" data-target="#exampleGrid" data-toggle="modal" type="button">Generate</button>
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="example-wrap m-md-0">
                        ...
                        <div class="example">
                            <div class="example-well h-350">
                                <img class="center" src="base/assets/examples/images/modal/style-modal.png" alt="...">
                            </div>
                            <p>We provide six color options for modal title background color.
                            </p>
                            <div class="color-selector-wrap clearfix">
                                <p class="float-left pt-5 mr-20">Choose color generate:</p>
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            <div class="example-well h-350 example-fill-in">
                                <img class="center" src="base/assets/examples/images/modal/fillin-modal.png" alt="...">
                            </div>
                            <p>This modal zooms from the middle and fills in fill-in to the
                                modal.</p>
                            <button class="btn btn-primary" data-target="#exampleFillIn" data-toggle="modal" type="button">Generate</button>
